...
```
コピーされた変数の値を変更しても、コピー元は変わりません。当然です。データXがあったとします。Xのバックアップを取っておいて(コピー/複製)、それをYとします。Yに対して何か破壊的な事をしてしまい、Yは壊れてしまいました。その時、Xは壊れているでしょうか。当然ながら、壊れていませんよね。といった単純な事です。